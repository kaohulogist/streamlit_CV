...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: Gray;">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#relevant-coursework">IIot | PLC | HMI | SCADA</a>
      </li>
      <li class="nav-item">
...
txt2_41('**Vinny AC, Houston, TX** *(AC Technician Associate)*','06/2021 - 06/2022')
st.markdown('''
...
- Documented resources management to record, update, and document directly to the regional manager.
...
- Developed the basic tool to learn semiconductor devices to understand modern electronics.
- Incorporated the basics of semiconductor materials and conduction processes in solids.
- Practiced lab cleanroom environment using boots, hood, safety glasses and gloves.
...
txt2_12('System Integration | Embedded', '`PLC` `HMI` `SCADA` `IIot` ')
